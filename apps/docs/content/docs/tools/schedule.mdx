...
- remind-meeting: "Remind about the meeting with Pierre" @ runAt: 2026-03-15T14:00:00Z (enabled)
```
...
```json
{
  ...
  "arguments": {
    ...
    "prompt": "Remind Alexis about his meeting with Pierre in 15 minutes."
  }
}
```
