...
This allows tools to read/write memory, manage scheduled jobs, and access configuration -- all without needing their own initialization.
...
Augure currently provides 5 native tools:
